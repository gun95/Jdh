                ...
                Task.Factory.StartNew(() =>
                    {
                       ...
                       // Dictionary<int, int> dic = new Dictionary<int, int>();
                        ...
                        while (true)
                        {
                            ...
                            while (t < mapLock.Count)
                            {
                                if (mapLock[t].ContainsKey(new List<int>(dic.Keys)[0]) && mapLock[t].ContainsValue(new List<int>(dic.Values)[0]))
                                {
                                    System.Diagnostics.Debug.WriteLine("remove row : " + new List<int>(dic.Keys)[0] + " colum : " + new List<int>(dic.Values)[0]);
