...
namespace Jdh
{
    class Program
    {
        ...
        static void MakeWave(int rowStartWave, int columStartWave, Semaphore semaphoreObject)
        {
            Random rnd = new Random();
            int rowStartWave = rnd.Next(0, 4);
            if ()
            {
                ...
                Task.Factory.StartNew(() =>
                    {
                        ...
                        int columStartWave = rnd.Next(0, 19); // creates a number between 1 and 12
                       ...
                       // Dictionary<int, int> dic = new Dictionary<int, int>();
                        ...
                        while (true)
                        {
                            ...
                            if (columStartWave < 17 && Chroma.Instance.Keyboard[rowStartWave, columStartWave] == Color.Black)
                                    MakeWave(rowStartWave, columStartWave, semaphoreObject);
