...
namespace Jdh
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<Dictionary<string, double>> mapLock = new List<Dictionary<string, double>>();
                ...
                Task.Factory.StartNew(() =>
                    {
                        ...
                        while (true)
                        {
                            ...
                            if (!arrayRow.Contains(rowStartWave) && !arrayColum.Contains(columStartWave))
                            {
                                semaphoreObject.WaitOne();
                                arrayRow.Add(rowStartWave);
                                arrayColum.Add(columStartWave);
                                arrayColum.Add(columStartWave + 1);
                                arrayColum.Add(columStartWave + 1);
                                arrayColum.Add(columStartWave + 1);
