...
namespace Jdh
{
    class Program
    {
       ...
       static Corale.Colore.Razer.Keyboard.Key [] j = { Key.A, Key.Z, Key.E, Key.S, Key.W , Key.A};
        static Corale.Colore.Razer.Keyboard.Key[] d = { Key.A, Key.Z, Key.E, Key.S, Key.W, Key.A };
