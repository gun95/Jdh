                ...
                Task.Factory.StartNew(() =>
                    {
                       ...
                       // Dictionary<int, int> dic = new Dictionary<int, int>();
                        ...
                        while (true)
                        {
                            ...
                            if (columStartWave < 17 && Chroma.Instance.Keyboard[rowStartWave, columStartWave] == Color.Black && leftOrRight == 0)
                                    MakeWaveRight(rowStartWave, columStartWave, semaphoreObject);
                            else if (columStartWave < 17 && Chroma.Instance.Keyboard[rowStartWave, columStartWave] == Color.Black && leftOrRight == 1)
