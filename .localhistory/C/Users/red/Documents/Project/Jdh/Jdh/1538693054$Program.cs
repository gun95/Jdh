    ...
    class Program
    {
       ...
       static Corale.Colore.Razer.Keyboard.Key[] KeyD = { Key.T, Key.Y, Key.U, Key.G, Key.J, Key.V, Key.B, Key.N};
        ...
        static void MakeJ()
        {
            ...
            while (i < KeyJ.Length)
            {
                keyboardGrid[KeyJ[i]] = ColoreColor.Green;
                i++;
            }
            keyboardGrid[4, 2] = ColoreColor.Green;
        }
        ...
        static void MakeD()
        {
            ...
            while (i < KeyD.Length)
            {
                keyboardGrid[KeyD[i]] = ColoreColor.Green;
                i++;
            }
        }
        ...
        static void MakeH()
        {
            ...
            keyboardGrid[3, 11] = ColoreColor.Green;
        ...
        {
            Chroma.Instance.SetAll(ColoreColor.Purple);
